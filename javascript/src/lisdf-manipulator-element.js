...
import LISDFViewer from './lisdf-viewer-element.js';
import { PointerURDFDragControls } from './URDFDragControls.js';

// lisdf-manipulator element
// Displays a LISDF scene where each URDF model can be manipulated with the mouse
...
export default
class LISDFManipulator extends LISDFViewer {
